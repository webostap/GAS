...
namespace P {
	...
	const double segment_size = stream_width / segment_count;

	const unsigned burn_index_steps = 100;
	const double burn_index_window = stream_width / P::burn_index_steps;
	...
	const double front_line_window = stream_width / 25;
